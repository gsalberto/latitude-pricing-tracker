...
const HETZNER_PRODUCTS = [
  // AX42 removed - it's a Ryzen 7 PRO 8700GE, NOT an EPYC server
  // AX52 removed - also Ryzen, NOT an EPYC server
  // AX102 removed - it's a Ryzen 9 7950X3D (128GB max), NOT an EPYC server
  // Only AX162-R and AX162-S are EPYC 9454P servers
